...
class BukuController extends Controller
{
    ...
    public function setEditorialPick(Request $request, string $id)
    {
    $buku = Buku::findOrFail($id);

    $buku->editorial_pick = $request->has('editorial_pick');
    $buku->save();

    return redirect()->back()->with('success', 'Editorial pick updated!');
    }
